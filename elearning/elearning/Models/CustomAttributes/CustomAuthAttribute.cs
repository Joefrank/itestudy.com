...
{
    public class CustomMemberAuthAttribute : AuthorizeAttribute 
    {
        ...
        public CustomMemberAuthAttribute(string roles)
            : base()
        {
            RequiredRoles = new List<string> { roles };
        }

        public CustomMemberAuthAttribute(List<string> roles)
            : base()
        {           
            RequiredRoles = roles;
        }       
